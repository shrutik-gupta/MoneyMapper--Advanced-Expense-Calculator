...
public class CreateAccount extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        try
        {
            ...
            {
                db.DbConnector.st.executeUpdate("insert into login_info values ('"+s1+"','"+s2+"')");
